...
//  GearHeads
//
//  Created by Brandon Dowless on 9/26/21.
//

import UIKit
import ActiveLabel

protocol RevHeaderDelegate: AnyObject {
...
class TweetHeader: UICollectionReusableView {
    ...
    weak var delegate: RevHeaderDelegate?
    ...
    private lazy var retweetButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleRevTapped), for: .touchUpInside)
        return button
    }()
