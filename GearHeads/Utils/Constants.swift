...
let REF_REVS = DB_REF.child("revs")
let REF_USER_REVS = DB_REF.child("user-revs")
let REF_USER_FOLLOWERS = DB_REF.child("user-followers")
let REF_USER_FOLLOWING = DB_REF.child("user-following")
let REF_REVS_REPLIES = DB_REF.child("revs-replies")
let REF_USER_LIKES = DB_REF.child("user-likes")
let REF_REV_LIKES = DB_REF.child("rev-likes")
